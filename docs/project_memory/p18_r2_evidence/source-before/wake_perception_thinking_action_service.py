    ...
    def _continue_mind(self, awakening, depth):
        ...
        if session is None:
            ...
            thinking = self._thinking.handle_perception(perception, depth=depth, think_id=think_id,
                ...
                **({'execution_guard': self._runtime_guard, 'input_validator': core.validate_input_material,
                    'result_validator': core.validate_thinking_material} if self._runtime_guard is not None else {}))
