"""One durable P15 test invocation; original outputs survive Fixture cleanup."""
import contextlib
import datetime
import hashlib
import json
        ...
        with contextlib.redirect_stdout(stdout), contextlib.redirect_stderr(stderr):
            try:
                ...
                if prefixes == ['--independent-probe']:
                    ...
                    spec=importlib.util.spec_from_file_location('p15_review_probe',DIRECTORY/'independent/p15_review_probe.py')
