...
class MemoryRepository(Protocol):
    ...
    def current_usable(self, subject_id: str, memory_id: str, *, include_self: bool = True) -> bool: ...

    def apply_lifecycle(self, command, evaluate): ...

    def summary_weight(self, summary: DerivedSummary) -> float: ...

    def event_recall_weights(self, subject_id: str) -> dict[str, float]: ...
