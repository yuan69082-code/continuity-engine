...
当前 P08 / Engine side / 十二项均 `ACCEPTED`，用户于 2026-09-04 正式验收（D-052）；D-051 的有限授权与历史仍有效。本文件不修改外部 Capability v1，不扩大方案 A、不代表生产 exactly-once，也不授权生产 Adapter、P09/P17 或 Git 操作。P08 Vio dependency=NONE，P09—P23=NOT_STARTED。
